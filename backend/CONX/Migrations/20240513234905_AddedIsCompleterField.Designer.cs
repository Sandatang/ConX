...
namespace CONX.Migrations
{
    ...
    [Migration("20240513234905_AddedIsCompleterField")]
    partial class AddedIsCompleterField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CONX.Models.AccountDeactivationLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DeactivatedAccountId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DeactivatedAccountName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DeactivatorId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DeactivatorName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CONX.Models.BulletinPost", b =>
                {
                    ...
                    b.ToTable("BulletinPost");
                });

            modelBuilder.Entity("CONX.Models.BulletinPostComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CONX.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CONX.Models.JuncWorkshopResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorkshopResources");
                });

            modelBuilder.Entity("CONX.Models.LoginLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CONX.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CONX.Models.Resource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EmpResources");
                });

            modelBuilder.Entity("CONX.Models.Testimony", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CONX.Models.Training", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CONX.Models.TrainingRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CONX.Models.Workshop", b =>
                {
                    b.Property<int>("WorkshopId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CONX.Models.BulletinPostComment", b =>
                {
                    b.HasOne("CONX.Models.BulletinPost", "BulletinPost")
                        .WithMany()
            ...
            modelBuilder.Entity("CONX.Models.Forum", b =>
                {
                    b.HasOne("CONX.Models.User", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("CONX.Models.JuncWorkshopResource", b =>
                {
                    b.HasOne("CONX.Models.Resource", "Resource")
                        .WithMany()
                        .HasForeignKey("ResourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CONX.Models.Workshop", "Workshop")
                        .WithMany()
            ...
            modelBuilder.Entity("CONX.Models.Resource", b =>
                {
                    b.HasOne("CONX.Models.User", "Uploader")
                        .WithMany()
            ...
            modelBuilder.Entity("CONX.Models.TrainingRegistration", b =>
                {
                    b.HasOne("CONX.Models.Training", "Training")
                        .WithMany()
            ...
            modelBuilder.Entity("CONX.Models.Workshop", b =>
                {
                    b.HasOne("CONX.Models.Category", "Category")
                        .WithMany()
