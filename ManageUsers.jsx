          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {sortedUsers.map(user => (
              <tr key={user.id}>
                ...
                {user.verified ? (
                  <div className="flex">
                    <button onClick={() => handleDeactivateUser(user.id)} className="text-red-500 mr-2 bg-red-100 px-3 py-1 rounded-md hover:bg-red-200">Reject</button>
                    <button onClick={() => handleActivateUser(user.id)} className="text-green-500 mr-2 bg-green-100 px-3 py-1 rounded-md hover:bg-green-200">Admit</button>
                  </div>
                ) : (
